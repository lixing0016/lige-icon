...
> 请勿 Fork，本项目会持续更新图标、规则与自用配置备份。如需引用或转载，请注明出处。
...
本项目主要用于备份和分享自用图标库、分流规则及部分插件配置，适用于 Quantumult X、Loon、Surge、Fileball、Senplayer、Yamby、Hills 等工具。

图标内容包括常用应用图标、国家/地区图标、机场 Logo、Emby 相关图标等，后续会不定期补充和更新。
...
| Senplayer | [一键导入 Emby 图标库](https://lige47.github.io/QuanX-icon-rule/scripts/import.html?iconset=https://raw.githubusercontent.com/lige47/QuanX-icon-rule/main/lige-emby-icon.json) |
